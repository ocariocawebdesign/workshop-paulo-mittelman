      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
        ...
        <div className="lg:col-span-12 lg:row-start-1 lg:col-start-1 z-40 pointer-events-none drop-shadow-[0_15px_30px_rgba(0,0,0,0.6)]">
          <motion.h1 
            ...
            className="text-[12vw] sm:text-[10.5vw] leading-[0.85] font-black uppercase tracking-tighter text-sand"
          >
            Análise<br />
        ...
        >
          ...
          <div className="absolute -bottom-4 -left-2 sm:-left-12 bg-onyx border border-brand-purple/30 p-4 sm:p-6 shadow-2xl z-30 ml-4 lg:ml-0">
             <p className="font-serif text-brand-light text-lg sm:text-xl italic mb-1">Workshop Online</p>
             <p className="font-sans font-bold text-sand tracking-widest uppercase text-xs sm:text-sm">Tratamento das Dependências</p>
          </div>
        </motion.div>
        ...
        <motion.div 
          ...
          className="lg:col-span-5 lg:col-start-1 lg:row-start-1 self-end z-40 lg:pb-12 mt-16 md:mt-32 lg:mt-0 relative"
        >
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-8 md:items-center">
              <a href="https://ocariocawebdesign.com.br/sprj/pagamento/index.php/produto/workshop-laura-silva/" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto group relative inline-flex items-center justify-center px-6 py-4 sm:px-10 sm:py-5 bg-brand-purple text-white font-black uppercase tracking-wider text-sm transition-all hover:bg-white hover:text-brand-purple rounded-sm overflow-hidden border border-brand-purple hover:border-white shadow-[0_0_20px_rgba(107,76,154,0.3)]">
